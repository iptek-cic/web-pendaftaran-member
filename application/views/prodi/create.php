		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					...
					<!-- /.box-header -->
					<div class="box-body">
						<form action="<?= linkTo('data-prodi/create') ?>" class="form" method="POST" enctype="multipart/form-data">
							
                     <div class="row">
                        <label for="nama_prodi" class="col-md-2 col-md-offset-1">Nama Prodi</label>
                        <div class="col-md-7">
                           <input type="text" class="form-control" name="nama_prodi" autocomplete="off" required value="<?= set_value('nama_prodi') ?>">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-7">
                           <textarea name="keterangan" rows="3" class="form-control" style="resize: none;"><?= set_value('keterangan') ?></textarea>
